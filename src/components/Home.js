    ...
    render(){
        ...
        <div className="main-container">
                    ...
                    <div className="row">
                        <div className="col-sm-8 col-md-6">
                            ...
                            <div className="video-cover border--round">
                                <div className="background-image-holder">
                                    <img alt="image" src="/dist/img/blog-3.jpg" />
                                </div>
                                <div className="video-play-icon"></div>
                                <iframe data-src="https://www.youtube.com/embed/6p45ooZOOPo?autoplay=1" allowFullScreen={true}></iframe>
                            </div>
                            {/*<!--end video cover-->*/}
            ...
            <footer className="footer-6 unpad--bottom  bg--dark ">
                ...
                {/*<!--end of container-->*/}
                {/*<div className="footer__lower text-center-xs">
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-6">
